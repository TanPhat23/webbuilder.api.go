...
type Project struct {
	...
	Elements     []Element        `gorm:"foreignKey:ProjectId" json:"elements,omitempty"`
	Pages        []Page           `gorm:"foreignKey:ProjectId" json:"pages,omitempty"`
	Owner        User             `gorm:"foreignKey:OwnerId" json:"owner,omitempty"`
	Snapshots    []Snapshot       `gorm:"foreignKey:ProjectId" json:"snapshots,omitempty"`
	MarketplaceItem *MarketplaceItem `gorm:"foreignKey:ProjectId" json:"marketplaceItem,omitempty"`
	Collaborators []Collaborator  `gorm:"foreignKey:ProjectId" json:"collaborators,omitempty"`
	Invitations  []Invitation     `gorm:"foreignKey:ProjectId" json:"invitations,omitempty"`
}
