...
const file_proto_service_proto_rawDesc = "" +
	"\n" +
	"\x13proto/service.proto\x12\aelement\"\x80\x04\n" +
	"\aElement\x12\x0e\n" +
	...
	"\belements\x18\x0e \x03(\v2\x10.element.ElementR\belementsB\n" +
	"\n" +
	"\b_contentB\a\n" +
	"\x05_nameB\x12\n" +
	...
	"\x0fElementSerivice\x12K\n" +
	"\fSaveSnapshot\x12\x1c.element.SaveSnapshotRequest\x1a\x1d.element.SaveSnapshotResponseB\x19Z\x17my-go-app/proto/elementb\x06proto3"
...
var file_proto_service_proto_goTypes = []any{
	(*Element)(nil),              // 0: element.Element
	(*SaveSnapshotRequest)(nil),  // 1: element.SaveSnapshotRequest
	(*SaveSnapshotResponse)(nil), // 2: element.SaveSnapshotResponse
}
var file_proto_service_proto_depIdxs = []int32{
	0, // 0: element.Element.elements:type_name -> element.Element
	1, // 1: element.ElementSerivice.SaveSnapshot:input_type -> element.SaveSnapshotRequest
	2, // 2: element.ElementSerivice.SaveSnapshot:output_type -> element.SaveSnapshotResponse
